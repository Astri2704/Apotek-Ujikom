...
<div class="site-section">
    <div class="container">
        <form action="{{route('cart_user.store')}}" method="POST">
            @csrf
        <div class="row">
                ...
                <p> <strong class="text-primary h4">Rp.{{number_format($obat->harga,0,'.','')}}</strong></p>
                    <div class="mb-5">
                        <div class="input-group mb-3" style="max-width: 220px;">
                            ...
                            <input type="number" name="jumlah" class="form-control text-center" value="1" placeholder=""
                    ...
                    {{-- <p><a href="{{url('cart')}}" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">
                        ...
                        {{-- <button type="submit" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">
                            Beli</button> --}}
                        <button type="submit" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" value="Add To Cart">
                            Add To Cart</button>
                    </p>
                    <div class="mt-5">
