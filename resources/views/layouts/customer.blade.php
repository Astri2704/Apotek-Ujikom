    ...
    <div class="site-navbar py-2">
      ...
      <div class="search-wrap">
       ...
       <div class="container" style="margin-top:-70px">
        <div class="d-flex align-items-center" style="display: flex; flex-direction:row; gap:300px; transform:translateY(70px)">
          ...
          <div class="main-nav d-none d-lg-block">  
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="/about" style="font-weight: bold">About</a></li>
                 <li>
                    ...
                    <a href="/cart_user" class="icons-btn d-inline-block bag">
              ...
              <div style="position: relative; transform:translateX(250px) translateY(-71px);font-weight: bold;">
                @if (Route::has('login'))
