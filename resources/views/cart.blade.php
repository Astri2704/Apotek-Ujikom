...
<div class="site-section">
    <div class="container">
                ...
                <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ $data->obat->image() }}" style="width: 100px; height:100px" alt="">
                                </td>
                                        ...
                                        <div class="mb-5">
                                            <div class="input-group mb-3" style="max-width: 220px;">
                                                <div class="input-group-prepend">
                                                    ...
                                                    value="{{ $data->jumlah }}" placeholder=""
                                                    aria-label="Example text with button addon"
                                                    aria-describedby="button-addon1">
                                                    <div class="inp ut-group-append">
                                            ...
                                            <td>
                                                <form action="{{ route('cart_user.destroy', $data->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                                            ...
                                            <td>
                                                <form action="{{ route('cart_user.update', $data->id) }}" method="post">
                                                    @csrf
                                                    @method('put')
                                                    <button type="submit" class="btn btn-sm btn-outline-danger"
                                                        onclick="return confirm('Apakah Anda Yakin?')">Update
                                                    </button>
                                                </form> 
                                            </td>
                                        </tr>
        ...
        <form class="col-md-12" action="{{route('checkout.store')}}" method="POST">
            @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="row mb-5">
